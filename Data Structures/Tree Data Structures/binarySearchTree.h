...
#define CREATE_BST(type)                                                                                  \
  ...
  typedef struct type##_binarySearchTree {                                                                \
    ...
    type##_bstNode* (*_get_node)(struct type##_binarySearchTree* b, const type value);                    \
    ...
    void            (*_insert)(struct type##_binarySearchTree* b, const type value);                      \
    void            (*_erase)(struct type##_binarySearchTree* b, const type value);                       \
  ...
  type##_bstNode* type##_get_last_node(type##_bst* b) {                                                   \
    ...
    return trav;                                                                                          \
                                                                                                          ...
                                                                                                          \
  type##_bstNode* type##_get_node(type##_bst* b, const type value) {                                      \
    if (b == NULL)                                                                                        \
      return NULL;                                                                                        \
                                                                                                          \
    type##_bstNode* trav = b->root;                                                                       \
  ...
  type type##_node_value(type##_bst* b, type##_bstNode* n) {                                              \
    ...
    return n->value;                                                                                      \
                                                                                                          ...
                                                                                                          \
  void type##_insert(type##_bst* b, const type value) {                                                   \
    if (b == NULL)                                                                                        \
      return;                                                                                             \
                                                                                                          \
    if (b->size == 0) {                                                                                   \
      ...
      if (value == trav->value)                                                                           \
        ...
        if (trav->right != NULL)                                                                          \
          ...
          return;                                                                                         \
                                                                                                          ...
                                                                                                          \
  void type##_erase(type##_bst* b, const type value) {                                                    \
    if (b == NULL)                                                                                        \
      return;                                                                                             \
                                                                                                          \
    if (b->size == 0)                                                                                     \
